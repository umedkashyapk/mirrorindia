                    ...
                    <?php if (!empty($this->menu_links)):
                        foreach ($this->menu_links as $item): ?>
                            <?php if ($item->item_visibility == 1 && $item->item_location == "top"): ?>
                                <li>
                                <?php if($item->item_name == "Legal") { ?>
                                    <div class="dropdown">
                                        <a style="color: #ccc !important; font-size: 12px"><?php echo html_escape($item->item_name); ?></a>
                                        <div class="dropdown-content">
                                            <a href="<?php echo generate_menu_item_url($item); ?>" style="font-size:12px">Supreme Court</a>
                                            <a href="<?php echo generate_menu_item_url($item); ?>" style="font-size:12px">High Court</a>
                                            <a href="<?php echo generate_menu_item_url($item); ?>" style="font-size:12px">Others</a>
                                        </div>
                                    </div>
                                <?php }else { ?>
