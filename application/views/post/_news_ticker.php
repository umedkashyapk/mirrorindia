                ...
                <div class="news-ticker">
                    <ul class="newsticker">
                        <?php foreach ($breaking_news as $post): ?>
                            <li>
                                <a href="<?php echo generate_post_url($post); ?>"<?php post_url_new_tab($this, $post); ?> style="padding-left: 3px;">
                                ...
                                ?>
                                - 
                                <a style="font-weight: 700;background: grey;padding: 3px">
                                    <?php echo html_escape($post->state); ?>
                                </a>
                                <?php } ?>
                            </li>
                        <?php endforeach; ?>
