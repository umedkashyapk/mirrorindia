...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="wr_input_post_title" class="form-control" name="state" placeholder="<?php echo trans('state'); ?>"
                   value="<?php echo old('state'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
        </div>
