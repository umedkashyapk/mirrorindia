                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                                <input type="radio" name="location" value="maini" id="manu_maini"
                                       class="square-purple" <?php echo (old("location") == "maini") ? 'checked' : ''; ?>>
                                <label for="manu_main" class="option-label"><?php echo trans(''); ?>Mini Manu</label>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-12 col-option">
